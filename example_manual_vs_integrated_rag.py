...
response = collection.query.near_vector(near_vector=query_vector, limit=10)
...
response = co.chat(model="command-r-plus", message=total_text)
...
client = weaviate.connect_to_local(headers={"X-Cohere-Api-Key": cohere_key})
